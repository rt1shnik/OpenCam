...
public class AlmalenceGUI extends GUI implements
	...
	private static final Map<String, Integer> ICONS_DEFAULT_ISO = new HashMap<String, Integer>() {
		{
			put(MainScreen.getInstance().getResources()
	...
	private static final Map<Integer, String> NAMES_SCENE = new HashMap<Integer, String>() {
		{
			put(CameraParameters.SCENE_MODE_AUTO, MainScreen.getInstance()
					.getResources().getString(R.string.sceneAuto));
			put(CameraParameters.SCENE_MODE_ACTION, MainScreen.getInstance()
					.getResources().getString(R.string.sceneAction));
			put(CameraParameters.SCENE_MODE_PORTRAIT, MainScreen.getInstance()
					.getResources().getString(R.string.scenePortrait));
			put(CameraParameters.SCENE_MODE_LANDSCAPE, MainScreen.getInstance()
					.getResources().getString(R.string.sceneLandscape));
			put(CameraParameters.SCENE_MODE_NIGHT, MainScreen.getInstance()
					.getResources().getString(R.string.sceneNight));
			put(CameraParameters.SCENE_MODE_NIGHT_PORTRAIT,
					MainScreen.getInstance().getResources()
							.getString(R.string.sceneNightPortrait));
			put(CameraParameters.SCENE_MODE_THEATRE, MainScreen.getInstance()
					.getResources().getString(R.string.sceneTheatre));
			put(CameraParameters.SCENE_MODE_BEACH, MainScreen.getInstance()
					.getResources().getString(R.string.sceneBeach));
			put(CameraParameters.SCENE_MODE_SNOW, MainScreen.getInstance()
					.getResources().getString(R.string.sceneSnow));
			put(CameraParameters.SCENE_MODE_SUNSET, MainScreen.getInstance()
					.getResources().getString(R.string.sceneSunset));
			put(CameraParameters.SCENE_MODE_STEADYPHOTO,
					MainScreen.getInstance().getResources()
							.getString(R.string.sceneSteadyPhoto));
			put(CameraParameters.SCENE_MODE_FIREWORKS, MainScreen.getInstance()
					.getResources().getString(R.string.sceneFireworks));
			put(CameraParameters.SCENE_MODE_SPORTS, MainScreen.getInstance()
					.getResources().getString(R.string.sceneSports));
			put(CameraParameters.SCENE_MODE_PARTY, MainScreen.getInstance()
					.getResources().getString(R.string.sceneParty));
			put(CameraParameters.SCENE_MODE_CANDLELIGHT,
					MainScreen.getInstance().getResources()
							.getString(R.string.sceneCandlelight));
			put(CameraParameters.SCENE_MODE_BARCODE, MainScreen.getInstance()
					.getResources().getString(R.string.sceneBarcode));
		}
	};

	private static final Map<Integer, String> NAMES_WB = new HashMap<Integer, String>() {
		{
			put(CameraParameters.WB_MODE_AUTO, MainScreen.getInstance()
					.getResources().getString(R.string.wbAuto));
			put(CameraParameters.WB_MODE_INCANDESCENT, MainScreen.getInstance()
					.getResources().getString(R.string.wbIncandescent));
			put(CameraParameters.WB_MODE_FLUORESCENT, MainScreen.getInstance()
					.getResources().getString(R.string.wbFluorescent));
			put(CameraParameters.WB_MODE_WARM_FLUORESCENT,
					MainScreen.getInstance().getResources()
							.getString(R.string.wbWarmFluorescent));
			put(CameraParameters.WB_MODE_DAYLIGHT, MainScreen.getInstance()
					.getResources().getString(R.string.wbDaylight));
			put(CameraParameters.WB_MODE_CLOUDY_DAYLIGHT,
					MainScreen.getInstance().getResources()
							.getString(R.string.wbCloudyDaylight));
			put(CameraParameters.WB_MODE_TWILIGHT, MainScreen.getInstance()
					.getResources().getString(R.string.wbTwilight));
			put(CameraParameters.WB_MODE_SHADE, MainScreen.getInstance()
					.getResources().getString(R.string.wbShade));
		}
	};

	private static final Map<Integer, String> NAMES_FOCUS = new HashMap<Integer, String>() {
		{
			put(CameraParameters.AF_MODE_AUTO, MainScreen.getInstance()
					.getResources().getString(R.string.focusAuto));
			put(CameraParameters.AF_MODE_INFINITY, MainScreen.getInstance()
					.getResources().getString(R.string.focusInfinity));
			put(CameraParameters.AF_MODE_NORMAL, MainScreen.getInstance()
					.getResources().getString(R.string.focusNormal));
			put(CameraParameters.AF_MODE_MACRO, MainScreen.getInstance()
					.getResources().getString(R.string.focusMacro));
			put(CameraParameters.AF_MODE_FIXED, MainScreen.getInstance()
					.getResources().getString(R.string.focusFixed));
			put(CameraParameters.AF_MODE_EDOF, MainScreen.getInstance()
					.getResources().getString(R.string.focusEdof));
			put(CameraParameters.AF_MODE_CONTINUOUS_VIDEO,
					MainScreen.getInstance().getResources()
							.getString(R.string.focusContinuousVideo));
			put(CameraParameters.AF_MODE_CONTINUOUS_PICTURE,
					MainScreen.getInstance().getResources()
	...
	private static final Map<Integer, String> NAMES_FLASH = new HashMap<Integer, String>() {
		{
			put(CameraParameters.FLASH_MODE_OFF, MainScreen.getInstance()
					.getResources().getString(R.string.flashOff));
			put(CameraParameters.FLASH_MODE_AUTO, MainScreen.getInstance()
					.getResources().getString(R.string.flashAuto));
			put(CameraParameters.FLASH_MODE_SINGLE, MainScreen.getInstance()
					.getResources().getString(R.string.flashOn));
			put(CameraParameters.FLASH_MODE_REDEYE, MainScreen.getInstance()
					.getResources().getString(R.string.flashRedEye));
			put(CameraParameters.FLASH_MODE_TORCH, MainScreen.getInstance()
					.getResources().getString(R.string.flashTorch));
		}
	};

	private static final Map<Integer, String> NAMES_ISO = new HashMap<Integer, String>() {
		{
			put(CameraParameters.ISO_AUTO, MainScreen.getInstance()
					.getResources().getString(R.string.isoAuto));
			put(CameraParameters.ISO_50, MainScreen.getInstance()
					.getResources().getString(R.string.iso50));
			put(CameraParameters.ISO_100, MainScreen.getInstance()
					.getResources().getString(R.string.iso100));
			put(CameraParameters.ISO_200, MainScreen.getInstance()
					.getResources().getString(R.string.iso200));
			put(CameraParameters.ISO_400, MainScreen.getInstance()
					.getResources().getString(R.string.iso400));
			put(CameraParameters.ISO_800, MainScreen.getInstance()
					.getResources().getString(R.string.iso800));
			put(CameraParameters.ISO_1600, MainScreen.getInstance()
					.getResources().getString(R.string.iso1600));
			put(CameraParameters.ISO_3200, MainScreen.getInstance()
					.getResources().getString(R.string.iso3200));
		}
	};
	...
	public int getFocusIcon(int focusMode) {
		if (ICONS_FOCUS.containsKey(focusMode)) {
			try {
				...
				e.printStackTrace();
				Log.e("getFocusIcon",
						"icons_focus.get exception: " + e.getMessage());
				return -1;
			}
		} else
			return -1;
	...
	public void onStart() {
		...
		iCenterViewMaxHeight = (int) (MainScreen.getMainContext()
				.getResources().getInteger(R.integer.centerViewHeight) * fScreenDensity);
		...
		// <!-- -+-
		RotateImageView unlock = ((RotateImageView) guiView
				.findViewById(R.id.Unlock));
		unlock.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (guiView.findViewById(R.id.postprocessingLayout)
						.getVisibility() == View.VISIBLE)
					return;

				if (MainScreen.getInstance().titleUnlockAll == null
						|| MainScreen.getInstance().titleUnlockAll
	...
	private void initOrientationListener() {
		...
		this.orientListener = new OrientationEventListener(
			...
			public void onOrientationChanged(int orientation) {
				...
				final Display display = ((WindowManager) MainScreen
				...
				boolean remapOrientation = Util.shouldRemapOrientation(
						orientationProc, rotation);
				...
				PluginManager.getInstance().onOrientationChanged(
	...
	private void createMergedSelectModeButton() {
		...
		try {
			...
			Bitmap iconOverlay = BitmapFactory
					.decodeResource(
			...
			bm = Bitmap.createScaledBitmap(bm, (int) (MainScreen
					.getMainContext().getResources()
	...
	public void onResume() {
		...
		disableCameraParameter(CameraParameter.CAMERA_PARAMETER_ISO, false,
				false);
		disableCameraParameter(CameraParameter.CAMERA_PARAMETER_METERING,
				false, false);
		disableCameraParameter(CameraParameter.CAMERA_PARAMETER_CAMERACHANGE,
				false, true);
...
//			guiView.findViewById(R.id.hintLayout).setVisibility(View.VISIBLE);
	...
	public void createInitialGUI() {
		...
		((RelativeLayout) MainScreen.getInstance().findViewById(
				R.id.mainLayout1)).addView(guiView);
	}
	...
	public void onCreate() {
		...
		guiView.findViewById(R.id.sceneButton).setOnTouchListener(
				MainScreen.getInstance());
		guiView.findViewById(R.id.wbButton).setOnTouchListener(
				MainScreen.getInstance());
		guiView.findViewById(R.id.focusButton).setOnTouchListener(
				MainScreen.getInstance());
		guiView.findViewById(R.id.flashButton).setOnTouchListener(
				MainScreen.getInstance());
		guiView.findViewById(R.id.isoButton).setOnTouchListener(
				MainScreen.getInstance());
		guiView.findViewById(R.id.meteringButton).setOnTouchListener(
				MainScreen.getInstance());
		...
		isoButtons = initCameraParameterModeButtons(ICONS_ISO, NAMES_ISO,
				isoButtons, MODE_ISO);
		meteringModeButtons = initCameraParameterModeButtons(ICONS_METERING,
				NAMES_METERING, meteringModeButtons, MODE_MET);
	...
	public void onGUICreate() {
		if (MainScreen.getInstance().findViewById(R.id.infoLayout)
				.getVisibility() == View.VISIBLE)
			iInfoViewHeight = MainScreen.getInstance()
					.findViewById(R.id.infoLayout).getHeight();
		...
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(MainScreen.getMainContext());
		boolean showDelayedCapturePrefCommon = prefs.getBoolean(
				MainScreen.sShowDelayedCapturePref, false);
		...
		if (infoSet == INFO_PARAMS && !isAnyViewOnViewfinder()) {
			infoSet = INFO_ALL;
			prefs.edit().putInt(MainScreen.sDefaultInfoSetPref, infoSet)
					.commit();
		}
		...
		GridView panel = (GridView) guiView
			    .findViewById(R.id.settingsGrid);
			  if(MainScreen.mHeightSOSEnabled!=0){
			   int height=panel.getLayoutParams().height;
			   panel.setNumColumns(4);
			   panel.invalidate();
			  }
...
//		hintLayout.bringToFront();
	...
	public void setupViewfinderPreviewSize(CameraController.Size previewSize) {
		Log.d("GUI",
				"setupViewfinderPreviewSize. Width = " + previewSize.getWidth()
						+ " Height = " + previewSize.getHeight());
		float cameraAspect = (float) previewSize.getWidth()
		...
		Log.d("GUI", "setLayoutParams. width = " + lp.width + " height = "
				+ lp.height);
	...
	public void onCameraCreate() {
		...
		if (supported_flash != null
				...
				&& activeFlash != null
				&& !(supported_flash.length == 1 && CameraController
						.isModeAvailable(supported_flash,
								CameraParameters.FLASH_MODE_OFF))) {
			for (int flash_name : supported_flash) {
				if (flashModeButtons.containsKey(flash_name)) {
					activeFlash.add(flashModeButtons.get(Integer
							.valueOf(flash_name)));
		...
		String qc1 = prefs.getString(
				MainScreen.getAppResources().getString(
						R.string.Preference_QuickControlButton1),
				defaultQuickControl1);
		String qc2 = prefs.getString(
				MainScreen.getAppResources().getString(
						R.string.Preference_QuickControlButton2),
				defaultQuickControl2);
		String qc3 = prefs.getString(
				MainScreen.getAppResources().getString(
						R.string.Preference_QuickControlButton3),
				defaultQuickControl3);
		String qc4 = prefs.getString(
				MainScreen.getAppResources().getString(
						R.string.Preference_QuickControlButton4),
		...
		if (mEVSupported) {
			PluginManager.getInstance().sendMessage(
					PluginManager.MSG_BROADCAST, PluginManager.MSG_EV_CHANGED);
		}
	...
	private View getFreeQuickControlButton(String qc1, String qc2, String qc3,
		...
		while (topMenuButtonsIterator.hasNext()) {
			...
			if (checkTopMenuButtonIntegerID(topMenuButton, buttonID, id1, id2,
					id3, id4)
		...
		while (topMenuPluginButtonsIterator.hasNext()) {
			...
			if (checkTopMenuButtonStringID(topMenuButton, buttonID, qc1, qc2,
					qc3, qc4))
				return topMenuButton;
		}
	...
	private boolean checkTopMenuButtonStringID(final View topMenuButton,
			final String buttonID, final String qc1, final String qc2,
			final String qc3, final String qc4) {
		return topMenuButton != quickControl1 && topMenuButton != quickControl2
	...
	// Util function used to check if topMenuButton already added to top menu
	private boolean checkTopMenuButtonIntegerID(final View topMenuButton,
			final int buttonID, final int qc1, final int qc2, final int qc3,
			final int qc4) {
		return topMenuButton != quickControl1 && topMenuButton != quickControl2
				&& topMenuButton != quickControl3
				&& topMenuButton != quickControl4 && buttonID != qc1
	...
	private void addQuickSetting(SettingsType type, boolean isQuickControl) {
		...
		case SCENE:
			...
			icon_text = MainScreen.getAppResources().getString(
			...
			view.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					try {
						...
						String title = plugin.getQuickControlTitle();
						Drawable icon = MainScreen.getMainContext()
						...
						e.printStackTrace();
						Log.e("Almalence GUI",
								"createPluginQuickControlOnClick exception"
										+ e.getMessage());
					}
				}
			});
		...
		focus.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				try {
					...
					e.printStackTrace();
					Log.e("createQuickControlFocusOnClick",
							"icons_focus.get exception: " + e.getMessage());
				}
	...
	private void createQuickControlMeteringOnClick(View metering) {
		metering.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				switchViews(currentQuickView, metering,
						String.valueOf(MODE_MET));
				recreateQuickControlsMenu();
	...
	private void showQuickControlsSettings() {
		...
		while (it.hasNext()) {
			...
			if (currentQuickView != topMenuButtons.get(key)) {
				...
				topMenuButtons.get(key).setBackgroundResource(
	...
	private void closeQuickControlsSettings() {
		...
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_SCENE),
				isSceneEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_WB), isWBEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_FOCUS),
				isFocusEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_FLASH),
				isFlashEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_ISO), isIsoEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_MET),
				isMeteringEnabled);
		correctTopMenuButtonBackground(
				MainScreen.getInstance().findViewById(MODE_CAM),
	...
	private void createSettingSceneOnClick(View settingView) {
		settingView.setOnClickListener(new OnClickListener() {
			public void onClick(final View v) {
				...
				int[] supported_scene = CameraController
	...
	private void createSettingWBOnClick(View settingView) {
		settingView.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				int[] supported_wb = CameraController
	...
	private void createSettingFocusOnClick(View settingView) {
		settingView.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				int[] supported_focus = CameraController
	...
	private void createSettingFlashOnClick(View settingView) {
		settingView.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				int[] supported_flash = CameraController
	...
	private void createSettingMeteringOnClick(View settingView) {
		settingView.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				int iMeteringAreasSupported = CameraController
	...
	private void showModeList() {
		...
		int modeHeightByDimen = Math.round(MainScreen.getAppResources()
				...
				+ MainScreen.getAppResources().getDimension(
	...
	private void setInfo(boolean toLeft, float xToVisible, float xToInvisible,
		...
		switch (infoSet) {
		case INFO_ALL:
			zonesVisibility = initZonesVisibility(View.VISIBLE, View.VISIBLE,
					View.VISIBLE);
			break;

		case INFO_NO:
			zonesVisibility = initZonesVisibility(View.GONE, View.GONE,
					View.GONE);
			break;
		...
		case INFO_PARAMS:
			zonesVisibility = initZonesVisibility(View.VISIBLE, View.GONE,
					View.GONE);
			break;
		default:
			break;
		}
		applyZonesVisibility(zonesVisibility, isAnimate, toLeft, rlvisible,
				lrvisible, rlinvisible, lrinvisible);
	...
	private int[] initZonesVisibility(final int zoneVisibiltyFirst,
			final int zoneVisibiltySecond, final int zoneVisibilityThird) {
	...
	private void applyZonesVisibility(int[] zonesVisibility, boolean isAnimate,
			boolean toLeft, AnimationSet rlvisible, AnimationSet lrvisible,
			AnimationSet rlinvisible, AnimationSet lrinvisible) {
		hideSecondaryMenus();
		unselectPrimaryTopMenuButtons(-1);
		...
		if (guiView.findViewById(R.id.paramsLayout).getVisibility() != zonesVisibility[0]) {
			if (isAnimate)
				guiView.findViewById(R.id.paramsLayout)
						.startAnimation(
								toLeft ? zonesVisibility[0] == View.VISIBLE ? rlvisible
										: rlinvisible
										: zonesVisibility[0] == View.VISIBLE ? lrvisible
												: lrinvisible);
		...
		if (guiView.findViewById(R.id.pluginsLayout).getVisibility() != zonesVisibility[1]) {
			if (isAnimate)
				guiView.findViewById(R.id.pluginsLayout)
						.startAnimation(
								toLeft ? zonesVisibility[1] == View.VISIBLE ? rlvisible
										: rlinvisible
										: zonesVisibility[1] == View.VISIBLE ? lrvisible
												: lrinvisible);
			guiView.findViewById(R.id.pluginsLayout).setVisibility(
					zonesVisibility[1]);

			if (isAnimate)
				guiView.findViewById(R.id.infoLayout)
						.startAnimation(
								toLeft ? zonesVisibility[1] == View.VISIBLE ? rlvisible
										: rlinvisible
										: zonesVisibility[1] == View.VISIBLE ? lrvisible
		...
		if (guiView.findViewById(R.id.fullscreenLayout).getVisibility() != zonesVisibility[2]) {
			if (isAnimate)
				guiView.findViewById(R.id.fullscreenLayout)
						.startAnimation(
								toLeft ? zonesVisibility[2] == View.VISIBLE ? rlvisible
										: rlinvisible
										: zonesVisibility[2] == View.VISIBLE ? lrvisible
												: lrinvisible);
	...
	private void switchViews(View currentView, View newView, String qcID) {
		...
		if (currentView == quickControl1) {
			currentViewID = pref.getString(MainScreen.getAppResources()
					.getString(R.string.Preference_QuickControlButton1), "");
			currentQCNumber = 1;
		} else if (currentView == quickControl2) {
			currentViewID = pref.getString(MainScreen.getAppResources()
					.getString(R.string.Preference_QuickControlButton2), "");
			currentQCNumber = 2;
		} else if (currentView == quickControl3) {
			currentViewID = pref.getString(MainScreen.getAppResources()
					.getString(R.string.Preference_QuickControlButton3), "");
			currentQCNumber = 3;
		} else if (currentView == quickControl4) {
			currentViewID = pref.getString(MainScreen.getAppResources()
					.getString(R.string.Preference_QuickControlButton4), "");
			currentQCNumber = 4;
		}
	...
	private void removePluginViews() {
		...
		RelativeLayout pluginsLayout = (RelativeLayout) MainScreen
				.getInstance().findViewById(R.id.pluginsLayout);
		...
		RelativeLayout fullscreenLayout = (RelativeLayout) MainScreen
				.getInstance().findViewById(R.id.fullscreenLayout);
...
//		}
	...
	public void onButtonClick(View button) {
		...
		case R.id.buttonShutter:
			Vibrator vibration = (Vibrator) MainScreen.getMainContext()
...
//			}
	...
	private void setSceneMode(int newMode) {
		if (newMode != -1 && sceneModeButtons.containsKey(newMode)) {
			...
			mSceneMode = newMode;
		} else if (sceneModeButtons
				.containsKey(CameraParameters.SCENE_MODE_AUTO)) {
			CameraController
					.setCameraSceneMode(CameraParameters.SCENE_MODE_AUTO);
			mSceneMode = CameraParameters.SCENE_MODE_AUTO;
		} else if (CameraController.getSupportedSceneModes() != null) {
			CameraController.setCameraSceneMode(CameraController
					.getSupportedSceneModes()[0]);
		...
		if (mWB != -1) {
			...
			PluginManager.getInstance().sendMessage(
					PluginManager.MSG_BROADCAST, PluginManager.MSG_WB_CHANGED);
		}
		if (mFocusMode != -1) {
			try {
		...
		if (mISO != -1) {
			...
			PluginManager.getInstance().sendMessage(
					PluginManager.MSG_BROADCAST, PluginManager.MSG_ISO_CHANGED);
		}
	...
	private void setFocusMode(int newMode) {
		if (newMode != -1) {
			if (mSceneMode != CameraParameters.SCENE_MODE_AUTO
					&& mFocusMode != CameraParameters.AF_MODE_AUTO)
	...
	private void setFlashMode(int newMode) {
		if (newMode != -1) {
			...
			preferences.edit().putInt(MainScreen.sFlashModePref, newMode)
					.commit();
		}
	...
	private void setMeteringMode(int newMode) {
		if (newMode != -1 && mMeteringMode != newMode) {
			...
			preferences.edit().putInt(MainScreen.sMeteringModePref, newMode)
					.commit();
	...
	private void topMenuButtonPressed(int iTopMenuButtonPressed) {
		...
		if ((iTopMenuButtonPressed > -1 && isTopMenuButtonEnabled(iTopMenuButtonPressed))
			...
			pressed_button
					.setBackgroundDrawable(MainScreen
							.getMainContext()
							.getResources()
							.getDrawable(
	...
	private void showParams(int iButton) {
		...
		case MODE_ISO:
			...
			break;
		case MODE_MET:
			guiView.findViewById(R.id.meteringLayout).setVisibility(
					View.VISIBLE);
			break;
		default:
			break;
			...
			try {
				...
				if (desire_zone == Plugin.ViewfinderZone.VIEWFINDER_ZONE_FULLSCREEN
					...
					((RelativeLayout) guiView
							.findViewById(R.id.fullscreenLayout)).addView(view,
							0, (ViewGroup.LayoutParams) viewLayoutParams);
				else
				...
				e.printStackTrace();
				Log.e("Almalence GUI",
						"addPluginViews exception: " + e.getMessage());
			}
		}
	}
		...
		while (it.hasNext()) {
			try {
				...
				((ImageView) mode.findViewById(R.id.modeImage))
						.setImageResource(MainScreen
								.getInstance()
								.getResources()
								.getIdentifier(
										CameraController.isUseHALv3() ? tmp.iconHAL
												: tmp.icon,
										"drawable",
										MainScreen.getInstance()
												.getPackageName()));
				...
				int id = MainScreen
						...
						.getResources()
						.getIdentifier(
								CameraController.isUseHALv3() ? tmp.modeNameHAL
										: tmp.modeName, "string",
				...
				if (PluginManager.getInstance().getActiveModeID() == tmp.modeID) {
					mode.findViewById(R.id.modeSelectLayout2)
	...
	private boolean changeMode(View v) {
		activeMode.findViewById(R.id.modeSelectLayout2).setBackgroundResource(
				R.drawable.underlayer);
		v.findViewById(R.id.modeSelectLayout2).setBackgroundResource(
				R.drawable.thumbnail_background_selected_inner);
	...
	public void showToast(final View v, final int showLength,
		...
		MainScreen.getInstance().runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				if (withBackground)
					modeLayout.setBackgroundDrawable(MainScreen
							.getAppResources().getDrawable(
				...
				if (v != null) {
					RelativeLayout.LayoutParams pm = (RelativeLayout.LayoutParams) imgView
							.getLayoutParams();
					pm.width = (int) MainScreen.getAppResources().getDimension(
							R.dimen.mainButtonHeight);
					pm.height = (int) MainScreen.getAppResources()
	...
	protected android.widget.RelativeLayout.LayoutParams getTunedPluginLayoutParams(
		...
		case VIEWFINDER_ZONE_FULLSCREEN: {
			currParams.width = MainScreen.getInstance().getPreviewSize() != null ? MainScreen
					.getInstance().getPreviewSize().getWidth()
					: 0;
			currParams.height = MainScreen.getInstance().getPreviewSize() != null ? MainScreen
					.getInstance().getPreviewSize().getHeight()
					: 0;
	...
	protected android.widget.RelativeLayout.LayoutParams findFreeSpaceOnLayout(
		...
		View pluginLayout = MainScreen.getInstance().findViewById(
				R.id.pluginsLayout);
	...
	public boolean onTouch(View view, MotionEvent event) {
		...
		if (view.getParent() == (View) MainScreen.getInstance().findViewById(
				R.id.paramsLayout)) {
			return false;
		}
	...
	public void setShutterIcon(ShutterButton id) {
		RotateImageView mainButton = (RotateImageView) guiView
				.findViewById(R.id.buttonShutter);
		// RotateImageView additionalButton = (RotateImageView)
		// guiView.findViewById(R.id.buttonShutterAdditional);
		RotateImageView buttonSelectMode = (RotateImageView) guiView
				.findViewById(R.id.buttonSelectMode);
		LinearLayout buttonShutterContainer = (LinearLayout) guiView
				.findViewById(R.id.buttonShutterContainer);
		...
		// 1 button
		if (id == ShutterButton.DEFAULT || id == ShutterButton.RECORDER_START
	...
	public boolean onKeyDown(boolean isFromMain, int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			// <!-- -+-
			if (((RelativeLayout) guiView
					.findViewById(R.id.viewPagerLayoutMain)).getVisibility() == View.VISIBLE) {
				hideStore();
				res++;
			}
			// -+- -->
	...
	public void openGallery(boolean isOpenExternal) {
		...
		boolean isAllowedExternal = prefs.getBoolean(
				MainScreen.getAppResources().getString(
						R.string.Preference_allowExternalGalleries), false);
		if (isAllowedExternal || isOpenExternal) {
			openExternalGallery(uri);
		} else {
			// if installed - run ABC Editor
			if (AppEditorNotifier
					.isABCEditorInstalled(MainScreen.getInstance())) {
				MainScreen.getInstance().startActivity(
						new Intent("com.almalence.opencameditor.action.REVIEW",
								uri));// com.almalence.opencameditor
			}
			...
			// it of run standard dialog
				...
				if (!AppEditorNotifier
						.showEditorNotifierDialogIfNeeded(MainScreen
								.getInstance()))
					openExternalGallery(uri);
			}
		}
	...
	public void onPostProcessingFinished() {
		...
		RelativeLayout pluginsLayout = (RelativeLayout) MainScreen
				.getInstance().findViewById(R.id.postprocessingLayout);
		for (int i = 0; i < pluginsLayout.getChildCount(); i++)
	...
	private class UpdateThumbnailButtonTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			mThumbnail = Thumbnail.getLastThumbnail(MainScreen.getInstance()
					.getContentResolver());
			return null;
		}
		...
		protected void onPostExecute(Void v) {
			if (mThumbnail != null) {
							...
							Bitmap bm = Thumbnail
									.getRoundedCornerBitmap(
											...
											(int) (MainScreen
													...
													.getResources()
													.getDimension(
															R.dimen.mainButtonHeight) * 1.2),
											(int) (MainScreen
													.getMainContext()
													.getResources()
													.getDimension(
															R.dimen.mainButtonHeight) / 1.1));
				...
				try {
					Bitmap bitmap = Bitmap.createBitmap(96, 96,
							Config.ARGB_8888);
	...
	public void startProcessingAnimation() {
		if (processingAnim != null
				&& processingAnim.getVisibility() == View.VISIBLE)
			return;

		processingAnim = ((ImageView) guiView.findViewById(R.id.buttonGallery2));
		processingAnim.setVisibility(View.VISIBLE);

		int height = (int) MainScreen.getAppResources().getDimension(
				R.dimen.paramsLayoutHeightScanner);
		int width = (int) MainScreen.getAppResources().getDimension(
				R.dimen.paramsLayoutHeightScanner);
	...
	public void stopCaptureIndication() {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(MainScreen.getMainContext());
		boolean photoTimeLapseActive = prefs.getBoolean(
				MainScreen.sPhotoTimeLapseActivePref, false);
		if (photoTimeLapseActive) {
			MainScreen.getInstance().guiManager
					.setShutterIcon(ShutterButton.DEFAULT);
	...
	public void showCaptureIndication() {
		...
		boolean photoTimeLapseActive = prefs.getBoolean(
				MainScreen.sPhotoTimeLapseActivePref, false);
		boolean photoTimeLapseIsRunning = prefs.getBoolean(
				MainScreen.sPhotoTimeLapseIsRunningPref, false);
		...
		new CountDownTimer(400, 200) {
			...
			public void onFinish() {
				if (!PluginManager.getInstance().getActiveModeID()
						.equals("video")) {
					((RotateImageView) guiView.findViewById(R.id.buttonShutter))
							.setImageResource(R.drawable.button_shutter);
				}
	...
	// mode help procedure
	@Override
	public void showHelp(String modeName, String text, int imageID,
			String preferences) {
		...
		TextView helpTextModeName = (TextView) guiView
				.findViewById(R.id.helpTextModeName);
		...
		Button buttonDontShow = (Button) guiView
				.findViewById(R.id.buttonDontShow);
